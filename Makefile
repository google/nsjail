...
test: $(BIN)
	...
	$(call run_test, ./nsjail -q -Mo --disable_clone_newuser --disable_clone_newns --disable_clone_newpid --disable_clone_newipc --disable_clone_newuts -u x:x -g x:x -- /usr/bin/id, 255)
	$(call run_test, ./nsjail -q -Mo --disable_clone_newuser --disable_clone_newns --disable_clone_newpid --disable_clone_newipc --disable_clone_newuts -u 0x10:0x10 -g 0x10:0x10 -- /usr/bin/id | grep -q 'uid=16.*gid=16', 0)
	$(call run_test, ./nsjail -q -Mo --chroot / --disable_clone_newuser --disable_clone_newpid --disable_clone_newipc --disable_clone_newuts --config tests/command-override.cfg -- /bin/false, 1)
