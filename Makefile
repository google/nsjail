...
BIN = nsjail
STATS_TEST_BIN = unotify/stats_test
...
clean:
	$(RM) core Makefile.bak $(OBJS) $(SRCS_PB_CXX) $(SRCS_PB_H) $(SRCS_PB_O) $(BIN) \
		$(STATS_TEST_BIN) unotify/stats_test.o
...
$(STATS_TEST_BIN): unotify/stats_test.o unotify/stats.o logs.o util.o config.pb.o \
	unotify/unotify.pb.o
	$(CXX) -o $@ $^ $(LDFLAGS)
...
unotify/stats_test.o: unotify/stats_test.cc unotify/stats.h nsjail.h config.pb.h
unotify/stats_test.o: unotify/record.h unotify/unotify.pb.h
