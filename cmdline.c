...
struct custom_option custom_opts[] = {
    ...
    { { "rlimit_stack", required_argument, NULL, 0x0207 }, "RLIMIT_STACK in MB, 'max' for the current hard limit, 'def' for the current soft limit, 'inf' for RLIM64_INFINITY (default: 'soft')" },
